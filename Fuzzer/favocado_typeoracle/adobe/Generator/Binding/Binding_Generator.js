...
function gen_ViewState() {
    addNewObject('viewState', 'ViewState');
    return '';
}
...
function gen_ShareIdentity() {
    addNewObject('shareIdentity', 'ShareIdentity');
    return '';
}

function gen_TTS() {
    addNewObject('tts', 'TTS');
    return '';
}

function gen_RSS() {
    addNewObject('RSS', 'RSS');
    return '';
}

function gen_Net() {
    addNewObject('Net', 'Net');
    return '';
}

function gen_Net_Subscriptions() {
    addNewObject('Net.Subscriptions', 'Net_Subscriptions');
    return '';
}

function gen_Net_Discovery() {
    addNewObject('Net.Discovery', 'Net_Discovery');
    return '';
}

function gen_Net_SOAP() {
    addNewObject('Net.SOAP', 'Net_SOAP');
    return '';
}
...
function gen_XMLData() {
    addNewObject('XMLData', 'XMLData');
    return '';
}

function gen_FormWorkflow() {
    addNewObject('FormWorkflow', 'FormWorkflow');
    return '';
}
